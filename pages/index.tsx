...
const Home = ({projects, skills, descriptions,EMAIL_SERVICE,EMAIL_KEY,EMAIL_TEMPLATE_ID}: InferGetStaticPropsType<typeof getStaticProps>) => {
            ...
            <div className="layout">
                ...
                <div className="content">
                    ...
                    <PortfolioSection projects={projects}
                                      description={descriptions.find(d => d.section_key === "projects")}/>
                    <div ref={footerRef}/>
                    <ContactSection email_service={EMAIL_SERVICE} email_key={EMAIL_KEY} email_template_id={EMAIL_TEMPLATE_ID} description={descriptions.find(d => d.section_key === "contact")}/>
                    <div className={style.blueFooter}>
                        <p className={style.footerText}>{localisation.locale === locales.francais ? "Développé par" : "Developed by"} Baptiste
                            Trautmann 2022 : <a href="https://github.com/BaptisteTr/personnalWebsite">sources</a></p>
                    </div>
                </div>
            </div>
        </div>
